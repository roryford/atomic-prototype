...
3. **Dark mode strategy** — [03-project-structure](./03-project-structure.md) shows `darkModeSelector: '.dark-mode'` but doesn't explain where the class toggle lives. OS preference media query? Manual toggle? Both?
